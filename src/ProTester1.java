...
public class ProTester1 {

	 ProTester simple_example, simple_cycle, complex_cycle, complex_graph;

	  @Before
	  public void setUp(){
	    simple_example = new ProTester(
	        new String[][]{{"A", "C"}, {"C", "D"}, {"B", "C"}}
	    );
	    simple_cycle = new ProTester(new String[][]{{"A", "A"}});
	    complex_cycle = new ProTester(new String[][]{{"A", "B"}, {"B", "A"}});
	    complex_graph = new ProTester(
	        new String[][]{
	            {"A", "C"}, {"C", "D"}, {"B", "C"},
	            {"A", "E"}, {"B", "F"}, {"E", "G"},
	            {"D", "G"}, {"F", "G"}, {"C", "E"},
	  ...
	  public void test_simple_example_10() {
	    assertFalse(simple_example.isWellSorted(new String[]{"C", "D", "A", "B", "X"}));
	  }
	  
	  @Test
	  public void test_cycle_5() {
	    assertFalse(simple_cycle.isWellSorted(new String[]{"A", "B"}));
	  }
	  
	  @Test
	  public void test_complex_cycle_4() {
	    assertFalse(complex_cycle.isWellSorted(new String[]{}));
	  }
